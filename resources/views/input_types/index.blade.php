...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Input Types</h4>
            </div>
        ...
        @if(count($inputTypes) == 0)
            <div class="panel-body text-center">
                <h4>No Input Types Available.</h4>
            </div>
        @else
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    @foreach($inputTypes as $inputType)
                        <tr>
                            <td>{{ $inputType->type }}</td>
                            <td>{{ $inputType->name }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('input_types.input_type.show', $inputType->id ) }}" class="btn btn-info" title="Show Input Type">
