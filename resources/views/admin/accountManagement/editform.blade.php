...
<div class="form-group {{ $errors->has('privilege') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
    	<select class="form-control" name="privilege">
    		<option value="1" {{ optional($user)->privilege == 1 ? "selected" : "" }}>User</option>
    		<option value="100" {{ optional($user)->privilege == 100 ? "selected" : "" }}>Admin</option>
    		<option value="0" {{ optional($user)->privilege == 0 ? "selected" : "" }}>Banned</option>
    	</select>
